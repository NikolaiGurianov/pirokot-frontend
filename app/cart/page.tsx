...
import { MapPin, Minus, PackageOpen, Plus, ShieldCheck, Trash2, Truck } from 'lucide-react';
...
export default function CartPage() {
  ...
  const deliveryIsFree = cart.totalMinor >= 300_000;
  const deliveryMinor = fulfillmentMethod === 'DELIVERY' && deliveryIsFree ? 0 : 50_000;
  const untilFreeDelivery = Math.max(0, 300_000 - cart.totalMinor);
